            ...
            <div className="max-w-4xl mx-auto px-4 py-24 pt-32">
                ...
                >
                    <h1 className="text-6xl font-black text-white mb-4">
                        Terms &{' '}
                        <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Rules</span>
                    </h1>
                    <p className="text-xl text-gray-400">Fair, transparent, and legally compliant giveaways</p>
                </motion.div>
                ...
                >
                    ...
                    <div className="space-y-4 text-gray-300">
                        ...
                        <p>
                            ...
                            <a href="#" className="text-purple-400 hover:text-pink-400 transition">Privacy Policy</a>.
                        </p>
                    </div>
                </motion.section>
